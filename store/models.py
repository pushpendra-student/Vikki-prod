...
class Order(models.Model):
    ...
    # if we endup cutomer calltion we don't endup deleting order
...
class Address(models.Model):
    ...
    # if you make this field to primary key then one customer have only one address
...
class CartItem(models.Model):
    ...
    class Meta:
        # this will ensure that user can not duplicate same product and  same cart twice
